...

{
	...
	TFile *f[1] = new TFile("../rootfiles/run_331/UNFILTERED/compass_run_331.root");
	f[0]->ls();
	...
	double channels[8] = {360,369,441.507,128,146,153,196,694.303};
	...
	for(int i = 0; i<NFILES; i++)
	{
		...
		t[i]->Project(name,"Energy+rndm()-0.5","Energy>0 && Board==0 && Channel==0");
	//	h[i]->Rebin(2);
	}
